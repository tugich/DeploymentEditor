...
If File
  ...
  CheckDatabaseUpdate(0, "INSERT INTO Parameters (Command, Parameter, Type, Description, Required, Control, SortIndex) VALUES (106, 'Action', 'String', 'Specifies the action to be performed. Available options: Install, Uninstall, Patch, Repair, ActiveSetup.', 1, 'String', 1)")
