...
function Install-ADTDeployment
{
    ...
    # Install 7-Zip with defaults
    Start-ADTProcess -ArgumentList "/S" -FilePath "7-Zip.exe"
    New-ADTShortcut -Description "7-Zip File Manager" -Path "$envCommonDesktop\Archive File Manager.lnk" -TargetPath "$envProgramFiles\7-Zip\7zFM.exe" -WorkingDirectory "$envProgramFiles\7-Zip"
    Show-ADTBalloonTip -BalloonTipText "Installed 7-Zip successfully!"
